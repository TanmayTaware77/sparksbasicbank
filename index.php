...
<html lang="en">
<head>
   <title>TRT Bank - Sabka Saath Sabka Vinaash</title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">TRT Bank  </a>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>TRT Bank</h1>
      <p1> TRT Bank is a part of Zombie foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
...
<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>Tanmay Taware</b> </br>Chairman, TRT Foundation</p>
      </footer>
